...
:Modified by Nancy Panousopoulou@FORTH-ICS <apanouso@ics.forth.gr> for the purposes of the distributed learning architecture library.

:Date of modification: 13/12/2017
...
from lib.deconvolve import spark_run
...
#def run_script(log):
def run_script(log, partitions_num=1):
    """Run script
    ...
    #opts.input = 'dedale_data/cube_10000_obj_var_euclid_sig0.01.npy'
    #opts.psf_file = 'dedale_data/cube_10000_obj_var_euclid_sig0.01.npy'
