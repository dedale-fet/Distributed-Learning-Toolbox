...
:Modified by Nancy Panousopoulou@FORTH-ICS (apanouso@ics.forth.gr) for adding the keyboard arguments for execution over the distributed learning archicture.

:Version: 2.4

:Initial Release: 23/10/2017
:Revised Release: 13/12/2017
...
def get_opts(args=None):
    ...
    #######################################################################
    #@nancypan-forthics: input argument for specifying the number of partitions for the data paralleization.
    optional.add_argument('--pn', type=int,  help='Number of Partitions')
